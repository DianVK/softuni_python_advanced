...
#                 output += f"\n{[customer for customer in self.customers if customer.id == subscription_id]}"
#                 output += f"\n{[trainer for trainer in self.trainers if trainer.id == subscription_id]}"
#                 output += f"\n{[equipment for equipment in self.equipment if equipment.id == subscription_id]}"
#                 output += f"\n{[plan for plan in self.plans if plan.id == subscription_id]}"
#                 return output
